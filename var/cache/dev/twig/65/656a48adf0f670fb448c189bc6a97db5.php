...
class __TwigTemplate_98d1873f27cacf2cb7bd1dc867e9a4e6 extends Template
{
    private $source;
    private $macros = [];
  ...
  <div class=\"card\">
    <div class=\"card-body login-card-body\">
        ...
        ";
        // line 15
        echo         $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->renderBlock((isset($context["passForm"]) || array_key_exists("passForm", $context) ? $context["passForm"] : (function () { throw new RuntimeError('Variable "passForm" does not exist.', 15, $this->source); })()), 'form_start');
        echo "
            ";
        // line 16
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["passForm"]) || array_key_exists("passForm", $context) ? $context["passForm"] : (function () { throw new RuntimeError('Variable "passForm" does not exist.', 16, $this->source); })()), "password", [], "any", false, false, false, 16), 'row');
        echo "
            <button type=\"submit\" class=\"btn btn-primary\" style=\"margin-top:15px\">Envoyer</button>
        ";
        // line 18
        echo         $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->renderBlock((isset($context["passForm"]) || array_key_exists("passForm", $context) ? $context["passForm"] : (function () { throw new RuntimeError('Variable "passForm" does not exist.', 18, $this->source); })()), 'form_end');
        echo "
    <!-- /.social-auth-links -->
      <p class=\"mb-1\">
        <a href=\"\">Login</a>
...
{% endblock %}
", "security/reset_password.html.twig", "C:\\xampp\\htdocs\\gestion-users\\templates\\security\\reset_password.html.twig");
    }
}

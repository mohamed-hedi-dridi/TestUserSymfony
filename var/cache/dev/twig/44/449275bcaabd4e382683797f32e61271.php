...
<div class=\"login-box\">
  ...
  ";
        // line 11
        $this->loadTemplate("_partials/_flash.html.twig", "security/login.html.twig", 11)->display($context);
        // line 12
        echo "  <!-- /.login-logo -->
  <div class=\"card\">
    <div class=\"card-body login-card-body\">
        ...
        // line 45
        echo "
            <button class=\"btn btn-primary btn-block\" style=\"margin:15px 0px 10px;\" type=\"submit\">
                Connexion
            </button>
        </form>
      <!-- /.social-auth-links -->
...
";
    ...
    {
        return array (  180 => 55,  174 => 52,  165 => 45,  160 => 33,  152 => 28,  147 => 25,  139 => 22,  136 => 21,  134 => 20,  131 => 19,  125 => 17,  123 => 16,  117 => 12,  115 => 11,  108 => 6,  98 => 5,  79 => 4,  60 => 3,  37 => 1,);
    }
...
<div class=\"login-box\">
  ...
  <div class=\"card\">
    <div class=\"card-body login-card-body\">
      ...
      <p class=\"mb-0\">
        <a href=\"{{ path('app_register')}}\" class=\"text-center\">S'inscrire</a>
      </p>
    </div>
    <!-- /.login-card-body -->
  </div>
...
{% endblock %}
", "security/login.html.twig", "C:\\xampp\\htdocs\\gestion-users\\templates\\security\\login.html.twig");
    }
}
